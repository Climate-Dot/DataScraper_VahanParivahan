...
class StateDataIngest:
    def __init__(self):
        ...
        self.staging_table_name = "staging_fact_ev_data_by_state"
        self.final_table_name = "fact_ev_data_by_state"
...
def main():
    ...
    if len(sys.argv) > 2:
        ...
        month, year = state_ev_data_ingest.get_year_month_label()
