...
class RTOLevelDataPreProcessor:
    ...
    def data_preprocessing(self):
        """
        function to process rto level historical data files
        """
                ...
                for state in os.listdir(self.raw_files_directory):
                    ...
                    for rto_office in os.listdir(state_path):
                        ...
                        raw_file_path = os.path.join(
                            rto_office_path, str(year), month, "reportTable.xlsx"
                        )
                        print(raw_file_path)
...
def main():
    ...
    final_df = rto_level_data_preprocessor.data_preprocessing()
    final_df.to_csv(f"rto_level_ev_data_historical_2013_2024.csv", header=True, index=False)
